...
!function ($) {
    $.fn.svgConvert = function (t) {
        ...
        }, t), s = this.selector, n = s.substring(1), a = $(s).length;
        e.imgCleanupAttr.push("alt", "src"), $(s).each(function (t) {
            var s = $(this), i = s.attr("src"), l = {};
            e.imgIncludeAttr && $.each(this.attributes, function () {
                this.specified && 0 !== e.imgCleanupAttr.indexOf(this.name) && ("class" === this.name && e.removeClass && (this.value = this.value.replace(n + " ", "")), "class" === this.name && e.addClass && (this.value = this.value += " " + e.addClass), l[this.name] = this.value)
            }), $.get(i, function (n) {
                var i = $(n).find("svg"), r;
                $.each(e.svgCleanupAttr, function (t, e) {
                    i.removeAttr(e)
                }), e.imgIncludeAttr && $.each(l, function (t, e) {
                    i.attr(t, e)
                }), s.replaceWith($(n).find("svg")), t + 1 === a && e.onComplete.call(this)
            })
        })
    }
}(jQuery);
...
jQuery(function ($) {
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            ...
            $('.stats-figures').bind('inview', function (event, isInView) {
                numcount()
            })
        }, 200)
    });
    $(document).ready(function () {
        // if (sw > 1200 & $('html').hasClass('home')) {
        //     var mainlayer = document.querySelector('.section--hero');
        //     var svgElement = document.querySelector('.screen-dots svg');
        //     var maskedElement = document.querySelector('#mask ellipse');
        ...
        //     }
        //
        //     mainlayer.addEventListener('mousemove', function (e) {
        ...
        $('.submenu__wrap .chevron').click(function () {
            if ((sw < 1100) || ((sw < 1400) && (sw > 1300) && (sh > 900))) {
                var $sthis = $(this).parent().find('.submenu');
                if ($sthis.is(":visible")) {
                    $sthis.slideUp()
                } else {
                    $('.submenu').slideUp();
                ...
                $(this).parent().find('.submenu__wrap .chevron').addClass('active')
            }
        });
        ...
        $('.inquire__popup').click(function () {
            $('.popup--div').addClass('popup__open');
            $('body').addClass('pos__fixed')
        });
        $('.cross__pop').click(function () {
            $('.popup--div').removeClass('popup__open');
            $('body').removeClass('pos__fixed')
        });
        $('.inquire__popup2').click(function () {
            $('.popup--div2').addClass('popup__open');
            $('body').addClass('pos__fixed')
        });
        $('.cross__pop2').click(function () {
            $('.popup--div2').removeClass('popup__open');
            $('body').removeClass('pos__fixed')
        });
        ...
        if ($(document).find('div').hasClass('js-testimonial')) {
            if ($('.js-testimonial .swiper-slide').length > 1) {
                var testSwipe = new Swiper('.js-testimonial .swiper-container', {
                    observer: !0,
                    observeParents: !0,
                    speed: 2000,
                    autoplay: {delay: 5000, disableOnInteraction: !1,},
                    pagination: {
                        el: '.swiper-pagination', clickable: !0, renderBullet: function (index, className) {
                            var chkindex = index + 1;
                            if (chkindex.toString().length > 1) {
        ...
        if ($(document).find('div').hasClass('js-cafeteria')) {
            if ($('.js-cafeteria .swiper-slide').length > 1) {
                var cafeswiper = new Swiper('.js-cafeteria .swiper-container', {
                    observer: !0,
                    observeParents: !0,
                    speed: 800,
                    autoplay: {delay: 3000, disableOnInteraction: !1},
                    navigation: {
                        nextEl: '.js-cafeteriaNav .swiper-button-next',
                        prevEl: '.js-cafeteriaNav .swiper-button-prev',
                    },
                })
            }
        }
        if ($(document).find('div').hasClass('js-meeting')) {
            if ($('.js-meeting .swiper-slide').length > 1) {
                var cafeswiper = new Swiper('.js-meeting .swiper-container', {
                    observer: !0,
                    observeParents: !0,
                    speed: 800,
                    autoplay: {delay: 3000, disableOnInteraction: !1},
                    navigation: {
                        nextEl: '.js-meetingNav .swiper-button-next',
                        prevEl: '.js-meetingNav .swiper-button-prev',
                    },
                })
            }
        }
    ...
    function numcount() {
        var a = 0;
        var al = $(document).find('.stats-figures').length;
        if (al > 0) {
            var oTop = $('.stats-figures').offset().top - window.innerHeight;
            if (a == 0) {
                $('.counter-value').each(function () {
                    var $this = $(this), animNumber = $this.attr('data-count'),
                        countTo = Math.floor($this.attr('data-count')), decimalValue = animNumber - countTo;
                    $({countNum: $this.text()}).animate({countNum: countTo}, {
                        duration: 1500,
                        easing: 'swing',
                        step: function () {
                            $this.text((Math.floor(this.countNum)) + decimalValue)
                        },
                        complete: function () {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > 400) {
            btn.addClass('show');
            $('.s-header').addClass('afix')
        } else {
            btn.removeClass('show');
            $('.s-header').removeClass('afix')
        }
    });
...
!function (d, l) {
    ...
    if (d.wp = d.wp || {}, !d.wp.receiveEmbedMessage) if (d.wp.receiveEmbedMessage = function (e) {
        ...
        if (t) if (t.secret || t.message || t.value) if (!/[^a-zA-Z0-9]/.test(t.secret)) {
            ...
            for (c = 0; c < s.length; c++) if (r = s[c], e.source === r.contentWindow) {
                if (r.removeAttribute("style"), "height" === t.message) {
                    if (1e3 < (a = parseInt(t.value, 10))) a = 1e3; else if (~~a < 200) a = 200;
                    r.height = a
                }
                if ("link" === t.message) if (i = l.createElement("a"), a = l.createElement("a"), i.href = r.getAttribute("src"), a.href = t.value, o.test(a.protocol)) if (a.host === i.host) if (l.activeElement === r) d.top.location.href = t.value
            }
        }
