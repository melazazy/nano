                ...
                <div class="table-responsive">
                    <table class="table table-centered table-hover table-nowrap mb-0"
                        ...
                        <thead class="bg-primary text-white">
                            <tr>
                                <th class="" style="width: 25%;">{{ __('messages.name') }}</th>
                                <th class="" style="width: 25%;">{{ __('messages.email') }}</th>
                                <th class="" style="width: 25%;">{{ __('messages.role') }}</th>
                                <th class="" style="width: 25%;">{{ __('messages.actions') }}</th>
                            </tr>
                        </thead>
                        <tbody>
