            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        <h1 class="mb-0 h3">{{ __('messages.sign_in') }}</h1>
                    </div>
                    ...
                    <form wire:submit="login" class="mt-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model="form.email" type="email"
                                    class="form-control rounded @error('form.email') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text rounded" id="basic-addon2">
                                        <svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                    ...
                                    <input wire:model="form.password" type="password" placeholder="Password"
                                        class="form-control rounded  @error('form.password') is-invalid @enderror"
                            ...
                            <div class="d-flex justify-content-between align-items-top mb-4">
                                ...
                                <div><a href="{{ route('password.request') }}"
                                        class="small text-right">{{ __('messages.lost_password') }}</a></div>
                            </div>
                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-gray-800">{{ __('messages.login') }}</button>
                        </div>
                    </form>
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-4">
                        <span class="fw-normal">
                            ...
                            <a href="{{ route('register') }}" class="fw-bold">{{ __('messages.create_account') }}</a>
                        </span>
                    </div>
                </div>
            </div>
